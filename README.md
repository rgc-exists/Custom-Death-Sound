# NOTE: This repository is currently showing an update to the mod that is currently in progress. For now, please go to the [original-mod branch](https://github.com/rgc-exists/Custom-Death-Sound/tree/original-mod) to see the version that is currently uploaded to Geode.
